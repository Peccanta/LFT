...
<body>
  ...
  <div class="content">
    <div class="container">
      ...
      <div class="image-rl"></div> <!-- МЕНЯТЬ В ЗАВИСИМОСТИ ОТ ИГРЫ -->
  ...
  <div id="player_list" class="area">
    ...
    <div class="center-image">
      <div class="second_img-rl"></div> <!-- МЕНЯТЬ В ЗАВИСИМОСТИ ОТ ИГРЫ -->
    </div>
  ...
  <div id="player_new" class="area">
    ...
    <div class="wrapper">
      <form method="POST" action="../forms/handle_forms.php">
        ...
        <input type="hidden" name="id_game" id="id_game" value="2"> <!-- МЕНЯТЬ ИГРУ В ЗАВИСИМОСТИ ОТ СТРАНИЦЫ -->
        <div class="group">
