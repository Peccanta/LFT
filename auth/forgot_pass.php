...
<head>
    ...
    <title>LFT | Восстановление пароля</title>
    ...
    <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="pass_recovery.php" method="post">
                    ...
                    <div class="text-center">
						<span class="successes p-t-12"></span>
					</div>
